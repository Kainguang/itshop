                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="https://www.pngarts.com/files/11/Rooster-Cock-Transparent-Image.png" class="avatar avatar-sm me-3" alt="user1">
                                                </div>
                                        ...
                                        <td class="align-middle">
                                            <form action="{{ route('product_types.destroy', $product->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
